    ...
    return (
        <div className="flex relative flex-col items-center mb-16 mt-12 md:mt-0 ">
            <div className="  w-72 md:w-72 md:h-72">
                ...
                <span className="absolute text-xl font-semibold hidden md:block text-white bottom-32 left-20 ">{blogCount}</span>
            </div>
            <h2 className="text-xl font-semibold bottom-1  left-10 hidden md:block  absolute text-white ">User Blogs</h2>
        </div>
    );
};
